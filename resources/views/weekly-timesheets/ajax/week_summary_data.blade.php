                    ...
                    @foreach ($entries as $key2 => $entry)
                        ...
                        <td class="p-1 hours-td date-index-{{ $key2 }}" data-index="{{ $key2 }}">
                            ...
                            <input type="number" 
                                ...
                                max="24" 
                                value="{{ $entry->hours }}" />
								<textarea placeholder="e.g. Working on new logo design" name="memo[{{ $key }}][]" rows="5" autocomplete="off" class="week-memo mt-2">{{ $entry->memo }}</textarea>
                        </td>
                    @endforeach
                </tr>
                @endforeach
                ...
                <tr>
                    ...
                    @foreach ($weekDates as $key2 => $day)
                        <td class="p-1 hours-td date-index-{{ $key2 }}" data-index="{{ $key2 }}">
                            ...
                            <input type="number" class="form-control week-hours height-35" name="hours[{{ $key }}][]" min="0" max="24" value="" placeholder="0" />
							<textarea placeholder="e.g. Working on new logo design" name="memo[{{ $key }}][]" rows="5" autocomplete="off" class="week-memo mt-2"></textarea>
                        </td>
                    @endforeach
                </tr>
