            ...
            @if ($smtpSetting->mail_driver == 'smtp')
                @if(!app()->environment(['production','demo']))
                    <x-alert type="danger" icon="info-circle">
                        It seems you have changed the <code class="font-weight-bold">APP_ENV=production</code> to
                ...
                @else
                    ...
                    <x-alert type="secondary" icon="info-circle">
                        ...
                        <ul>
                            <li class="py-2">1. <a href="https://get.smtp2go.com/veerenjp" target="_blank">SMTP2GO.COM</a></li>
                            <li>2. <a href="https://pstk.smtp.com/veerenjp" target="_blank">SMTP.COM</a></li>
                        </ul>
                    </x-alert>
                @endif
