<ul>
    @if(user()->is_superadmin)
        ...
        @if($sidebarSuperadminPermissions['view_companies'] != 5 && $sidebarSuperadminPermissions['view_companies'] != 'none')
            ...
            <x-menu-item icon="building" :text="__('superadmin.menu.companies')" :link="route('superadmin.companies.index')">
                <x-slot name="iconPath">
        ...
        @if($sidebarSuperadminPermissions['view_admin_faq'] != 5 && $sidebarSuperadminPermissions['view_admin_faq'] != 'none')
            ...
            <x-menu-item icon="files" :text="__('superadmin.menu.adminFaq')" :link="route('superadmin.faqs.index')">
                <x-slot name="iconPath">
        ...
        <x-menu-item icon="incognito" :text="__('superadmin.menu.offlineRequest')" :link="route('superadmin.offline-plan.index')" :count="$totalPendingOfflineRequests ?? 0">
            <x-slot name="iconPath">
        ...
        <x-menu-item icon="ticket-detailed" :text="__('superadmin.menu.supportTicket')" :link="route('superadmin.support-tickets.index')" :count="$totalOpenTickets ?? 0">
            <x-slot name="iconPath">
        ...
        <x-menu-item icon="front" :text="__('superadmin.menu.frontSettings')" :link="route('superadmin.front-settings.front_theme_settings')">
            <x-slot name="iconPath">
       ...
       @endif
        ...
        @foreach (hrm_plugins() as $item)
            @includeIf(strtolower($item).'::sections.superadmin.sidebar')
        @endforeach

        <x-menu-item icon="front" :text="__('superadmin.menu.setting')"
         :link="(user()->permission('manage_superadmin_app_settings') == 'all' ? route('app-settings.index') : route('superadmin.settings.super-admin-profile.index'))">
