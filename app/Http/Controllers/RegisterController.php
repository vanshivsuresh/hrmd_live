...
class RegisterController extends Controller
{
    ...
    public function acceptInvite(AcceptInviteRequest $request)
    {
        ...
        try {
            ...
            if (isHrmForSale() && $this->global->email_verification) {
    ...
    public function setupAccount(AccountSetupRequest $request)
    {
        if (isHrmForSale()) {
            ...
            return Reply::success('HRMS Application account created successfully. You will redirected to dashboard soon');
        }
