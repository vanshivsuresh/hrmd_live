...
class Module extends BaseModel
{
    ...
    public static function validateVersion($module)
    {
        ...
        if ($parentMinVersion >= File::get('version.txt')) {
            ...
            $message = 'To activate <strong>' . $module . '</strong> module, minimum version of <b>hrms application</b> must be greater than equal to <b>' . $parentMinVersion . '</b> But your application version is <b>' . File::get('version.txt') . '</b>. Please upgrade the application to latest version';
