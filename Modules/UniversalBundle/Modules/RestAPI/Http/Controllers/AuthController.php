...
class AuthController extends ApiBaseController
{
    ...
    public function login(LoginRequest $request)
    {
        ...
        if ($check) {
            ...
            if (isHrmForSale() && $user->is_superadmin) {
                $exception = new \veerenjp\RestAPI\Exceptions\UnauthorizedException('Sorry this app is not built for superadmin', null, 403, 403, 2006);

                return \veerenjp\RestAPI\ApiResponse::exception($exception);
            }
