                                ...
                                <div class="row mb-2">
                                    ...
                                    @if(is_null($salaryStructure))
                                        <div class="col-sm-12 pb-2 d-block d-lg-flex d-md-flex">
                                            ...
                                            <p class="mb-0 text-dark-grey f-14 w-70">
                                                {{ currency_format((int)$jobOffer->comp_amount, ($currency ? $currency->id : company()->currency->id )) }} @lang('recruit::modules.joboffer.per') {{ $jobOffer->job->pay_according }}</p>
                                        </div>
                                    @endif
                                    <div class="col-sm-12 pb-2 d-block d-lg-flex d-md-flex">
                                        <p class="mb-0 text-lightest f-14 w-30 d-inline-block ">
                                    ...
                                    <div class="col-sm-12 pb-2 d-block d-lg-flex d-md-flex">
                                        ...
                                        <p class="mb-0 text-dark-grey f-14 w-70">
                                            {!! $jobOffer->description ? $jobOffer->description : '--' !!}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
